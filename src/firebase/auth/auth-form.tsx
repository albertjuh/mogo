...
export function AuthForm({ mode }: AuthFormProps) {
  const { login, signup, loginWithGoogle, resetPassword } = useUser();
  ...
  // Web: Google Sign-In only. Native app: signInWithPopup can't complete inside
  // Capacitor's WebView (see use-user.tsx), so it keeps email/password until a
  // native Google Sign-In plugin is wired up.
  if (!isNativeApp) {
    return (
