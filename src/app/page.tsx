    ...
    <div className="space-y-6">
      ...
      <Card className="bg-primary text-primary-foreground border-none shadow-xl overflow-hidden relative">
        ...
        <CardHeader>
          ...
          <div className="text-4xl font-black italic">TZS {activeLoan.outstandingBalance.toLocaleString()}</div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Progress value={activeLoan.progressPercentage} className="bg-white/20 h-3" />
          </div>
          <div className="grid grid-cols-2 gap-4 pt-2">
            <div className="bg-white/10 p-3 rounded-lg">
                <p className="text-[0.65rem] uppercase font-bold opacity-70">Ulipaji Jumla</p>
                <p className="font-bold">TZS {activeLoan.totalAmountPaid.toLocaleString()}</p>
            </div>
            <div className="bg-white/10 p-3 rounded-lg">
                <p className="text-[0.65rem] uppercase font-bold opacity-70">Lengo</p>
        ...
        <div className="grid grid-cols-3 gap-3">
            ...
            <Link href="/savings" className="flex flex-col items-center p-3 bg-secondary rounded-xl gap-2 hover:bg-primary/10 transition-colors">
             ...
             <Link href="/contact" className="flex flex-col items-center p-3 bg-secondary rounded-xl gap-2 hover:bg-primary/10 transition-colors">
                ...
                <span className="text-[0.65rem] font-bold uppercase">Msaada</span>
            </Link>
        </div>
      </div>
    </div>
