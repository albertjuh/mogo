...
export const initialRiders: Rider[] = [
  { id: "rider-1", name: "Juma Hassan", phone: "0712345678", plateNumber: "T 123 BCD", shahidiNumber: "SH-9988", dailyFee: 15000, contractStart: formatISO(subDays(today, 270)), contractEnd: formatISO(addDays(today, 240)), active: true, bikeId: "bike-1", createdAt: formatISO(subDays(today, 270)) },
  { id: "rider-2", name: "Ally Ramadhan", phone: "0788112233", plateNumber: "T 445 DEF", shahidiNumber: "SH-1122", dailyFee: 15000, contractStart: formatISO(subDays(today, 30)), contractEnd: formatISO(addDays(today, 480)), active: true, bikeId: "bike-2", createdAt: formatISO(subDays(today, 30)) },
  { id: "rider-3", name: "Sofia Said", phone: "0655443322", plateNumber: "T 789 GHI", shahidiNumber: "SH-4455", dailyFee: 15000, contractStart: formatISO(subDays(today, 10)), contractEnd: formatISO(addDays(today, 500)), active: true, bikeId: "bike-3", createdAt: formatISO(subDays(today, 10)) },
];
...
export const initialPayments: Payment[] = [
  ...
  { id: "p2", riderId: "rider-2", amount: 15000, date: formatISO(subDays(today, 1)) },
...
export const initialLoans: Loan[] = [
  {
    id: "loan-1",
    clientId: "rider-1", // Matches the rider user ID for the client view
    loanType: "Boda Boda",
