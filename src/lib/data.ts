...
export const initialLoans: Loan[] = [
  ...
  },
  {
    ...
    interestRate: 0.15,
    loanTermMonths: 18,
    startDate: formatISO(subDays(today, 45)),
    endDate: formatISO(addDays(subDays(today, 45), 540)),
    nextPaymentDueDate: formatISO(addDays(today, 1)),
    minimumPaymentAmount: 15000,
  ...
  },
  {
    ...
    loanType: "Bajaji",
    principalAmount: 7500000,
    outstandingBalance: 7080000,
    interestRate: 0.12,
    loanTermMonths: 24,
    startDate: formatISO(subDays(today, 60)),
    endDate: formatISO(addDays(subDays(today, 60), 720)),
    nextPaymentDueDate: formatISO(addDays(today, 7)),
    minimumPaymentAmount: 105000,
    totalAmountPaid: 420000,
    loanStatus: "In Arrears",
